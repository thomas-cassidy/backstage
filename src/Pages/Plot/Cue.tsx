        ...
        <View style={styles.container}>
            <View style={styles.inner}>
                ...
                <View style={styles.location}>
                    <TextInput
                        editable={editing}
                        style={{ ...GlobalStyles.text_medium, color: GlobalColors.secondary }}
                    ...
                    <ScrollView >
                        {editing ?
                            ...
                            castMembers?.length === 0 ?
                                ...
                                :
                                castMembers?.map((c, i) => {
                                    const id = cast.find(x => x.role === c)?.id
                                    if (id != undefined) {
                                        return (
                                            <BarLink
                                                label={c}
                                                light={!editing}
                                                key={i}
                                                onPress={() => navigation.navigate('CastProfile', { id: id })}
                                            />
                                        )
                                    }
                                    return (
                ...
                {editing ?
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly' }}>
                        <RoundButton
                            ...
                            style={{ width: width * 0.4, marginBottom: 0, marginTop: Sizes.xs }} />
