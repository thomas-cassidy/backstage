...
import { ADD_PLOT_ASYNC } from "../../Redux/plots";
...
const NewCueSheet = ({ navigation }: Props) => {
  ...
  return (
    <SafeAreaView style={GlobalStyles.container}>
      <PageHeader back backLabel="Cancel" label={"New Plot"} />

      <View style={styles.form}>
        <View style={styles.formLine}>
          <Text style={styles.text_label}>Title:</Text>
          <TextInput
      ...
      <RoundButton
        ...
        onPress={async () => {
          ...
          await dispatch(ADD_PLOT_ASYNC(title));
          navigation.goBack();
        }}
      />
    </SafeAreaView>
